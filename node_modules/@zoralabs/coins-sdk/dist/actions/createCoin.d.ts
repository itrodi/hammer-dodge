...
export declare function createCoinCall({ name, symbol, uri, owners, payoutRecipient, initialPurchaseWei, tickLower, platformReferrer, }: CreateCoinArgs): SimulateContractParameters<typeof zoraFactoryImplABI, "deploy">;
/**
